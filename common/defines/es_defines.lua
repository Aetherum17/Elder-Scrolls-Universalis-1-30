...
NDefines.NAI.ARTILLERY_FRACTION = 0.5 	-- Ratio of artillery to infantry AI will build
...
NDefines.NAI.CORRUPTION_BUDGET_FRACTION = 0.5 -- AI will spend a maximum of this fraction of monthly income on rooting out corruption
...
NDefines.NReligion.PICK_GOLDEN_BULL_COST = 250							-- Integer cost for pick a golden bull
